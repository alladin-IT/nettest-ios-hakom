...
class RMBTTOSViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        agreeButtonItem?.setTitleTextAttributes([NSFontAttributeName: font], for: .normal)
        declineButtonItem?.setTitleTextAttributes([NSFontAttributeName: font], for: .normal)
