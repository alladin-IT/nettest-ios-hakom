...
class QOSUDPTestExecutor<T: QOSUDPTest>: QOSTestExecutorClass<T>, UDPStreamSenderDelegate, UDPStreamReceiverDelegate { /*swift compiler segfault if moved to extension*/
    ...
    override func executeTest() {
        ...
        if testObject.packetCountOut == nil && testObject.packetCountIn == nil {
            testResult.set(RESULT_UDP_NUM_PACKETS_OUTGOING_RESPONSE, value: "NOT_SET" as AnyObject?) // TODO: why is this cast necessary?
            testResult.set(RESULT_UDP_NUM_PACKETS_INCOMING_RESPONSE, value: "NOT_SET" as AnyObject?) // TODO: why is this cast necessary?
...
// MARK: test methods
    ...
    fileprivate func finishOutgoingTest() {
        testResult.set(RESULT_UDP_OUTGOING_PACKETS,                 value: resultPacketData.rcvServerResponse as AnyObject?) // TODO: why is this cast necessary?
        testResult.set(RESULT_UDP_NUM_PACKETS_OUTGOING_RESPONSE,    value: resultPacketData.numPackets as AnyObject?) // TODO: why is this cast necessary?
        ...
        if lostPackets > 0 {
            ...
            testResult.set(RESULT_UDP_OUTGOING_PLR, value: "\(packetLossRate)" as AnyObject?) // TODO: why is this cast necessary?
        } else {
            testResult.set(RESULT_UDP_OUTGOING_PLR, value: "0" as AnyObject?) // TODO: why is this cast necessary?
        }
...
// MARK: QOSControlConnectionDelegate methods
    ...
    ///
    fileprivate func appendPacketData(_ data: inout Data, flag: UInt8, packetNumber: UInt16) {
