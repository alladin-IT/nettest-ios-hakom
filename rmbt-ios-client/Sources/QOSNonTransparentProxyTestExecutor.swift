...
class QOSNonTransparentProxyTestExecutor<T: QOSNonTransparentProxyTest>: QOSTestExecutorClass<T>, GCDAsyncSocketDelegate {
    ...
    ///
    fileprivate let socketQueue = DispatchQueue(label: "at.alladin.rmbt.qos.ntp.socketQueue", attributes: DispatchQueue.Attributes.concurrent)
    ...
    override func startTest() {
        ...
        testResult.set(RESULT_NONTRANSPARENT_PROXY_REQUEST, value: testObject.request?.stringByRemovingLastNewline() as AnyObject?) // TODO: why is this cast necessary?
    }
    ...
    override func testDidSucceed() {
        testResult.set(RESULT_NONTRANSPARENT_PROXY_STATUS, value: "OK" as AnyObject?) // TODO: why is this cast necessary?
    ...
    override func testDidTimeout() {
        testResult.set(RESULT_NONTRANSPARENT_PROXY_STATUS, value: "TIMEOUT" as AnyObject?) // TODO: why is this cast necessary?
    ...
    override func testDidFail() {
        ...
        testResult.set(RESULT_NONTRANSPARENT_PROXY_RESPONSE, value: "" as AnyObject?) // TODO: why is this cast necessary?
        testResult.set(RESULT_NONTRANSPARENT_PROXY_STATUS, value: "ERROR" as AnyObject?) // TODO: why is this cast necessary?
        ...
        if sock == ntpTestSocket {
            ...
            case TAG_NTPTEST_REQUEST:
                ...
                if let response = SocketUtils.parseResponseToString(data) {
                    ...
                    testResult.set(RESULT_NONTRANSPARENT_PROXY_RESPONSE, value: response.stringByRemovingLastNewline() as AnyObject?) // TODO: why is this cast necessary?
