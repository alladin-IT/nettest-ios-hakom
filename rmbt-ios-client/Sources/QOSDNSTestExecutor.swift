...
class QOSDNSTestExecutor<T: QOSDNSTest>: QOSTestExecutorClass<T> {
    ...
    override func startTest() {
        ...
        testResult.set(RESULT_DNS_RESOLVER, value: (testObject.resolver ?? "Standard") as AnyObject?) // TODO: why is this cast necessary?
        testResult.set(RESULT_DNS_RECORD,   value: testObject.record! as AnyObject?) // TODO: why is this cast necessary?
        testResult.set(RESULT_DNS_HOST,     value: testObject.host! as AnyObject?) // TODO: why is this cast necessary?
    ...
    fileprivate func afterDNSResolution(_ startTimeTicks: UInt64, responseObj: DNSRecordClass?) throws {
        ...
        if let response = responseObj {
            ...
            // for response.resultRecords {
                ...
                testResult.set(RESULT_DNS_STATUS, value: response.rcodeString() as AnyObject?) // TODO: why is this cast necessary?

                // TODO: improve this section

                if let qType = response.qType {
                    let ipAddress = jsonValueOrNull(response.ipAddress as AnyObject!) // TODO: why is this cast necessary?
                    resultRecord[RESULT_DNS_ADDRESS] = ipAddress
                    ...
                    if let ttl = response.ttl {
                        resultRecord[RESULT_DNS_TTL] = "\(ttl)" as AnyObject?
                    }
        ...
        testResult.set(RESULT_DNS_ENTRIES_FOUND, value: resourceRecordArray.count as AnyObject?) // TODO: why is this cast necessary?
    ...
    override func testDidSucceed() {
        testResult.set(RESULT_DNS_QUERY, value: "OK" as AnyObject?) // TODO: why is this cast necessary?
    ...
    override func testDidTimeout() {
        testResult.set(RESULT_DNS_QUERY, value: "TIMEOUT" as AnyObject?) // TODO: why is this cast necessary?

        testResult.set(RESULT_DNS_ENTRY, value: /* [] as NSArray */nil)
        testResult.set(RESULT_DNS_ENTRIES_FOUND, value: 0 as AnyObject?) // TODO: why is this cast necessary?
    ...
    override func testDidFail() {
        testResult.set(RESULT_DNS_QUERY, value: "ERROR" as AnyObject?) // TODO: why is this cast necessary?
