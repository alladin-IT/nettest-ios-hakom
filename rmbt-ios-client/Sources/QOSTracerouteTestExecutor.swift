...
class QOSTracerouteTestExecutor<T: QOSTracerouteTest>: QOSTestExecutorClass<T> {
    ...
    override func startTest() {
        ...
        testResult.set(RESULT_TRACEROUTE_HOST,      value: testObject.host as AnyObject?) // TODO: why is this cast necessary?
    ...
    override func testDidSucceed() {
        ...
        testResult.set(RESULT_TRACEROUTE_STATUS,    value: "OK" as AnyObject?) // TODO: why is this cast necessary?
    ...
    override func testDidTimeout() {
        ...
        testResult.set(RESULT_TRACEROUTE_STATUS,    value: "TIMEOUT" as AnyObject?) // TODO: why is this cast necessary?
        testResult.set(RESULT_TRACEROUTE_HOPS,      number: ttl)
        testResult.set(RESULT_TRACEROUTE_DETAILS,   value: hopDetailArray as NSArray) // cast does not work if HopDetail is a struct
    ...
    override func testDidFail() {
        ...
        testResult.set(RESULT_TRACEROUTE_STATUS,    value: "ERROR" as AnyObject?) // TODO: why is this cast necessary?
