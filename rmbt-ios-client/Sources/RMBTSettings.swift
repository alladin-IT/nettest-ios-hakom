...
// MARK: User configurable properties
    ...
    ///
    open dynamic var soundsEnabled = true // TODO: app specific configuration should be moved to the ios app...

// MARK: Nerd mode

    ///
    open dynamic var nerdModeEnabled = true //false
    ...
    ///
    open dynamic var nerdModeQosEnabled = true
