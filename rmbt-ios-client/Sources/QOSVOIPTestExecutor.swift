...
class QOSVOIPTestExecutor<T: QOSVOIPTest>: QOSTestExecutorClass<T>, UDPStreamSenderDelegate {
    ...
    ///
    fileprivate var initialSequenceNumber = UInt16(arc4random_uniform(10000) + 1)
    ...
    override func startTest() {
        ...
        testResult.set(RESULT_VOIP_STATUS,          value: "OK" as AnyObject?) // TODO: why is casting necessary?
    ...
    override func testDidTimeout() {
        testResult.set(RESULT_VOIP_STATUS, value: "TIMEOUT" as AnyObject?) // TODO: why is casting necessary?
    ...
    override func testDidFail() {
        testResult.set(RESULT_VOIP_STATUS, value: "ERROR" as AnyObject?) // TODO: why is casting necessary?
